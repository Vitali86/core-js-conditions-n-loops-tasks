...
function isContainNumber(num, digit) {
  ...
  for (let i = 0; i < numText.length; i += 1) {
    if (numText[i] === String(digit)) {
      return true;
    }
  }
  return false;
